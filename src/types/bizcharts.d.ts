...
declare namespace bizcharts {
  ...
  export interface ChartProps extends React.DOMAttributes<{}>, React.Props<any> {
    ...
    onTooltipChange?(ev: { tooltip: any; x: number; y: number; items: any }): void;
    onTooltipShow?(ev: { tooltip: any; x: number; y: number }): void;
    onTooltipHide?(ev: { tooltip: any }): void;
    [event: string]: any;
  }
  ...
  export interface LegendProps extends React.Props<any> {
    ...
    itemTpl?:
      | string
      | ((value?: string, color?: string, checked?: boolean, index?: number) => string);
